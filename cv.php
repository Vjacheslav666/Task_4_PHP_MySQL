...
$workExperience = [
	[
    'workName' => 'Тут наименование профессии.',
    'workDate'=> 'Тут даты обучения/работ.',
    'sumary' => 'Тут о себе и о работе.'
    ],
    [
    'workName' => 'Тут наименование профессии.',
    'workDate'=> 'Тут даты обучения/работ.',
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <?php for ($i =0; $i < count($workExperience); $i++){ ?>
            <h5 class="w3-opacity"><b><?=$workExperience[$i]["workName"];?></b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?=$workExperience[$i]["workDate"];?></h6>
            <p><?=$workExperience[$i]["sumary"];?></p>
            <hr>
          <?php } ?>
          </div>         	
        </div>
